...
def data_prep_baseline(data_dir, train_batch, test_batch, train_split, logger, validation_threshold=0.9):
    # Does (r, theta)
    data_x = []
    data_y = []
...
#     # New data form
    ...
    theta = np.arccos(np.clip(cos_, -1+1e-5, 1-1e-5))
    data_x[:, 0,...] = mag
    data_x[:, 1,...] = theta
    data_x = data_x[:, :2,...]
...
def data_prep_baseline1(data_dir, train_batch, test_batch, train_split, logger, validation_threshold=0.9):
    # mag, cos(theta), sin(theta)
    data_x = []
    data_y = []
    for i, f in enumerate(listdir(data_dir)):
        if i % 1000 == 0:
...
def data_prep_baseline2(data_dir, train_batch, test_batch, train_split, logger, validation_threshold=0.9):
    # Does (x, y)
    data_x = []
    data_y = []
    for i, f in enumerate(listdir(data_dir)):
...
def data_prep_baseline4(data_dir, train_batch, test_batch, train_split, logger, validation_threshold=0.9):
    # offset by 1
    data_x = []
    data_y = []
    for i, f in enumerate(listdir(data_dir)):
...
def data_prep_baseline5(data_dir, train_batch, test_batch, train_split, logger, validation_threshold=0.9):
    # offset by 0.1
    data_x = []
    data_y = []
    for i, f in enumerate(listdir(data_dir)):
...
def data_prep_baseline6(data_dir, train_batch, test_batch, train_split, logger, validation_threshold=0.9):
    # offset by 0.01
    data_x = []
    data_y = []
    for i, f in enumerate(listdir(data_dir)):
